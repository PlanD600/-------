...
 * שינוי: הוספת undefined לטיפוס של currentUserRole כדי להתאים לערך האפשרי מ-useAuth.
*/
...
        // בדיקה לוודא שהפרמטרים קיימים לפני הקריאה ל-API.
...
    // שינוי: הוספת setError לרשימת החזרות
...
    // שינוי: קליטה של setError מה-Hook
    const { 
